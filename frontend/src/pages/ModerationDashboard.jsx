...
const MODERATOR_ID = "22299208";
const MODERATOR_NAME = "Nafis Sadik";
...
export default function ModerationDashboard() {
  ...
  const [moderatorNotes, setModeratorNotes] =
    useState({});
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-8">
          ...
          <p className="mt-3 max-w-3xl text-stone-600">
            Review reports submitted by readers
            and take appropriate moderation
            actions.
          </p>
        </section>
        ...
        <section className="mb-6 rounded-2xl border border-stone-200 bg-white p-5 shadow-sm">
          ...
          <select
            ...
            className="mt-2 w-full max-w-xs rounded-xl border border-stone-300 bg-white px-4 py-3 outline-none focus:border-[#8a5d42]"
          >
            {statusOptions.map(
              (status) => (
                <option
                    ...
                    <div className="mt-6 border-t border-stone-200 pt-6">
                      ...
                      <label className="block">
                        ...
                        <textarea
                          ...
                          className="mt-2 w-full resize-none rounded-xl border border-stone-300 px-4 py-3 outline-none focus:border-[#8a5d42]"
                        />
