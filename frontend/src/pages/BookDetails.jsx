        ...
        <div>
          ...
          <section className="mt-7 rounded-2xl border border-stone-200 p-5">
            ...
            <p className="mt-2 text-stone-600">
              ...
              Read what other BookVerse
              readers think, write your own
              review, like reviews, and join
              the discussion.
            ...
            <Link
              to={`/books/${id}/reviews`}
              className="mt-4 inline-block rounded-xl bg-[#6f3f26] px-5 py-3 font-semibold text-white transition hover:bg-[#57301d]"
            >
              Reviews & Comments
            </Link>
              ...
              {(data.shelfOptions ||
                ...
                (shelf) => (
                  ...
                  <button
                    ...
                    className="rounded-xl border-2 border-[#6f3f26] px-4 py-2 font-semibold text-[#6f3f26] transition hover:bg-[#f5ebe1]"
                  >
                    {shelf}
                  </button>
